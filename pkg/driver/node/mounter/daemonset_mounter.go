...
// A DaemonsetMounter is a [Mounter] that delegates Mountpoint process management
...
func (dm *DaemonsetMounter) Mount(ctx context.Context, bucketName string, target string,
	...
	if err != nil {
		// TODO: consider re-discovering in getCommDir (check existance, re-discover if needed) and just return error here
